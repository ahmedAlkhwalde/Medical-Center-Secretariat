...
//       currentWeek = Array(7).fill({ short: "", num: 0, dateISO: null });
//     }
//   }
...
//       item.short ? item : { short: indexedNames[idx], num: 0, dateISO: null },
//     );
//   }
...
//     if (activeDoctor?.selectedDate) return activeDoctor.selectedDate;
//     if (activeDoctor?.dateISO) return activeDoctor.dateISO;
//     return null;
//   }, [activeDoctor]);
...
const getWeeksInMonth = (year, monthName) => {
  ...
  let currentWeek = Array(7).fill({ short: "", num: 0, dateISO: null });
  const dayNames = ["SUN", "MON", "TUE", "WED", "THU", "FRI", "SAT"];
