...
const ScheduleFilters = ({
  searchQuery,
  onSearchChange,
  selectedSpecialtyUuid,       // ✅ تغيير الاسم
  onSpecialtyUuidChange,       // ✅ تغيير الدالة
  specialtyOptions = [],        // [{ uuid, name }]
  onResetFilters,
}) => {
      ...
      <div className="rounded-4xl theme-surface-90 p-5 md:p-6">
        <div className="mb-5 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="text-sm theme-text-muted">
              الفلترة تعمل على الخادم حسب الاختصاص المختار.
            </p>
          </div>
        ...
        <div className="grid gap-4 lg:grid-cols-[minmax(0,1.4fr)_minmax(260px,0.8fr)]">
          ...
          <label className="block">
            ...
            <div className="relative rounded-3xl border theme-border theme-surface">
              <select
                value={selectedSpecialtyUuid}
                onChange={(event) => onSpecialtyUuidChange(event.target.value)}
